...
public class GameService {
    ...
    public GameData getGame(Long gameId) {
        ...
        return GameData.builder()
                ...
                .ageRating(jsonObject.isNull("age_ratings")? -1 : CollectionCreateClass.GetAgeRating(jsonObject.getJSONArray("age_ratings")))
    ...
    public List<GameListItem> getHomePopular() {
        ...
        JSONArray jsonArray = new JSONArray(HttpRequestClass.sendPostRequestToIGDB(getGameFirstPartURL, "fields cover.url,name,rating,rating_count,release_dates.date; where id > 1000 & cover != null & release_dates != null & release_dates.date != null; limit 20; offset 20;", accessToken).body());
    ...
    public List<GameListItem> searchGames(String query) {
        ...
        JSONArray jsonArray = new JSONArray(HttpRequestClass.sendPostRequestToIGDB(getGameFirstPartURL, "fields cover.url,name,rating,rating_count,release_dates.date; where id > 1000 & cover != null & release_dates != null & release_dates.date != null; search \"" + query + "\";" + ";", accessToken).body());
