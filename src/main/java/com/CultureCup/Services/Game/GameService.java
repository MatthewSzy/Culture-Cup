...
public class GameService {
    ...
    public GameData getGame(Long gameId) {
        ...
        return GameData.builder()
                ...
                .releaseDates(CollectionCreateClass.CreateReleaseDatesCollection(jsonObject.getJSONArray("release_dates"), accessToken))
                ...
                .voteCount(jsonObject.getLong("total_rating_count"))
                .categories(CollectionCreateClass.CreateCategoriesCollection(jsonObject.getJSONArray("genres"), jsonObject.getJSONArray("themes")))
                .build();
    }
